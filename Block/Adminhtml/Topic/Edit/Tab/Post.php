...
namespace Baniwal\Blog\Block\Adminhtml\Topic\Edit\Tab;
...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('baniwal_blog_post_topic')],
    ...
    {
        return $this->coreRegistry->registry('baniwal_blog_topic');
    }
    ...
    {
        return $this->getUrl('baniwal_blog/topic/posts', ['_current' => true]);
    }
