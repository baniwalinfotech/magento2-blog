...
use Baniwal\Blog\Model\ResourceModel\Topic\CollectionFactory as BlogTopicCollectionFactory;
...
class Topic extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Baniwal_Blog::topic');
                            ...
                            "create_topic_modal": {
                                ...
                                "children": {
                                    "create_topic": {
                                        ...
                                        "render_url": "' . $this->_urlBuilder->getUrl('mui/index/render_handle', ['handle' => 'baniwal_blog_topic_create', 'buttons' => 1]) . '",
                                        "autoRender": false,
