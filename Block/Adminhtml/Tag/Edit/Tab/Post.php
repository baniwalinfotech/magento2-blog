...
namespace Baniwal\Blog\Block\Adminhtml\Tag\Edit\Tab;
...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('baniwal_blog_post_tag')],
    ...
    {
        return $this->coreRegistry->registry('baniwal_blog_tag');
    }
    ...
    {
        return $this->getUrl('baniwal_blog/tag/posts', ['_current' => true]);
    }
