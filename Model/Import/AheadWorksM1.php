...
class AheadWorksM1 extends AbstractImport
{
    ...
    protected function _importPosts($data, $connection)
    {
        ...
        if ($result) {
            ...
            $this->_registry->register('baniwal_import_post_tags_collection', $tags);
    ...
    protected function _importTags($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $tags = $this->_registry->registry('baniwal_import_post_tags_collection');
                ...
                foreach ($tagIds as $id) {
                    try {
                        ...
                        $this->_resourceConnection->getConnection()
                            ->insert($this->_resourceConnection->getTableName('baniwal_blog_post_tag'), ['tag_id' => $newTagId, 'post_id' => $postId, 'position' => 0]);
                    } catch (\Exception $e) {
                        continue;
                    }
                }
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $this->_importCategoryPost($data, $connection, $oldCategoryIds, 'baniwal_blog_post_category');
        }
