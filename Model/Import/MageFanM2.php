...
class MageFanM2 extends AbstractImport
{
    ...
    protected function _importPosts($data, $connection)
    {
        ...
        if ($result) {
            ...
            if ($isReplace && isset($sourceItems)) {
                 ...
                 */
                $topicPostTable = $this->_resourceConnection->getTableName('baniwal_blog_post_topic');
    ...
    protected function _importTags($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $tagPostTable = $this->_resourceConnection->getTableName('baniwal_blog_post_tag');
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
             ...
             */
            $categoryPostTable = $this->_resourceConnection->getTableName('baniwal_blog_post_category');
